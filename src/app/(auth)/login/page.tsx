...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-dark-950 flex items-center justify-center p-4">
      {/* Background grid */}
      <div className="absolute inset-0 bg-grid-dark bg-[size:32px_32px] opacity-100 pointer-events-none" />
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-dark-400 text-sm mt-1">Staff Portal</p>
        </div>

        {/* Card */}
        <div className="card p-6">
          <h2 className="text-lg font-semibold text-dark-100 mb-1">Sign in</h2>
          <p className="text-sm text-dark-400 mb-6">Enter your credentials to access the CRM.</p>
          ...
          <div className="mt-4 text-center">
            <a href="/reset-password" className="text-xs text-dark-400 hover:text-gold transition-colors">
        ...
        <p className="text-center text-xs text-dark-500 mt-6">
          Customer portal?{" "}
          <a href="/portal-login" className="text-gold hover:text-gold-light transition-colors">
            Sign in here
          </a>
        </p>
      </div>
