...
export const prescriptionSchema = z.object({
  ...
  next_exam_date: z.string().optional().nullable(),
  prescribing_optom: z.string().optional().nullable(),

  od_sph: rxNum,
  od_cyl: rxNum,
  od_axis: rxInt,
  od_add: rxNum,
  od_va: z.string().optional().nullable(),
  os_sph: rxNum,
  os_cyl: rxNum,
  os_axis: rxInt,
  os_add: rxNum,
  os_va: z.string().optional().nullable(),
  ...
  // Contact lens
  cl_od_brand: z.string().optional().nullable(),
  cl_od_base_curve: rxNum,
  cl_od_diameter: rxNum,
  cl_od_power: rxNum,
  cl_od_cylinder: rxNum,
  cl_od_axis: rxInt,
  cl_os_brand: z.string().optional().nullable(),
